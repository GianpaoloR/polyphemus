...
/*
  ...
  */
    ...
    cv::Point n;
    if (false)//rH->hasNose()) --> this is the only point in which rH->hasNose was still called.
              //hasNose() was used with Haar nose: it doesn't exist anymore.
    {
...
//    earL.x-=(evaluateRotationY(landmarks)*2);
    ...
    std::cout << "Distance: "  << eyeDim <<  std::endl;
